<?php include './logic/php/index3.php'; ?>
...
<body onload="getTime();setInterval('refresh()',3000)"><!-- 异步获取数据，单位‘毫秒’,30秒请求一次数据 -->
            ...
            $.ajax({ 
                ...
                success: function(result) { 
                    ...
                    deptPercentChart.setOption({
                        ...
                        series: [{
                            // data: result.data,
                            data: [50, 80,95,105,70,60,65,95,120,130,140,100,110,93,50,32],                            
                        }] //渲染数据
                    });
                }, 
                error: function() { 
