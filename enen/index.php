...
<head>
    ...
    <style>
        ...
        body{
            background:url(./logic/images/333.jpg)no-repeat;
            width:100%;
            height:100%;
            background-size:100% 100%;
            /* position:absolute; */
            filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='./logic/images/333.jpg',sizingMethod='scale');
        }
    </style>
</head>
<body onload="getTime();setInterval('refresh()',30000)"><!-- 异步获取数据，单位‘毫秒’,30秒请求一次数据 -->
